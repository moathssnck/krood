    ...
    <div className="min-h-screen bg-gray-50" dir="rtl">
      ...
      <div className="px-6 py-8 max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          <h1 className="text-2xl font-bold text-gray-800 text-center mb-6">مراجعة السجل الائتماني</h1>
          ...
          <div className="text-gray-700 text-lg leading-relaxed text-center space-y-4 mb-8">
            ...
            <p>
              ...
              <span className="font-bold text-blue-600"> 1 دينار كويتي </span>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-xl font-bold text-blue-600 text-center mb-6">مراجعة تاريخ الائتمان</h2>
          ...
          <div className="flex justify-center">
            <div className="relative">
              ...
              <div className="text-center text-blue-600 text-sm mt-1">سای نت</div>
